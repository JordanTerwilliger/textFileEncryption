...
-i <filename> : This flag specifies the input file, or source file, 
                containing the text to be encrypted or decrypted. 
                Substitute <filename> with your input file name.
